...
const HUB_CATEGORIES = {
  ...
  rewards: {
    ...
    allCommands: [
      ...
      { cmd: '!charkeys / !ck', desc: 'View your character key collection with progress bars' },
      { cmd: '!keyunlock <character>', desc: 'Unlock a character using 750 keys' },
      { cmd: '!convertkeys', desc: 'Convert excess keys for owned characters to tokens (1:1)' },
      { cmd: '!keyrush', desc: 'Activate Key Rush event (250 gems, 1 hour) - ZooAdmin only' },
      { cmd: '!keyrushstatus', desc: 'Check if Key Rush is currently active and time remaining' },
